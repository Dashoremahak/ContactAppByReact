    ...
    return (
        <div className="ml-10 pr-10">
            ...
            <div className="mb-2"> <p className="font-normal text-2xl pb-2">
                ...
                <input id="name" type="text" placeholder="Enter the Name" className="border rounded-sm border-blue-300 px-2 py-1" /></div>
           <div className="mb-2">
           <p className="font-normal text-2xl pb-2">
                Enter the Number:
            </p>
            <input  id="number" type="text" placeholder="Enter the Number" className="border rounded-sm border-blue-300 py-1 px-2 " />
           </div>
